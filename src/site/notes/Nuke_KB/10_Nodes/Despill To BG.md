---
{"dg-publish":true,"permalink":"/nuke-kb/10-nodes/despill-to-bg/","tags":["nuke","node","despill","keying"]}
---
...
```nuke
    ...
    set N205e3520 [stack 0]
    Dot {
    name Dot12
    xpos 569
    ypos 40
    }
    set N8dc1f400 [stack 0]
    Expression {
    temp_name0 avr
